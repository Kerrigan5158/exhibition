...
var FirstPersonControls = function ( object, domElement ) {
	...
	this.onMouseMove = function ( event ) {
		...
		if ( this.domElement === document ) {
			...
			this.mouseX =  this.startMouseX - event.pageX;//event.pageX - this.viewHalfX;
			this.mouseY =  this.startMouseY - event.pageY;//event.pageY - this.viewHalfY;
